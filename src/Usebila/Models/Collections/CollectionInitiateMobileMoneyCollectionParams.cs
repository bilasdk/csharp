...
/// </summary>
public record class CollectionInitiateMobileMoneyCollectionParams : ParamsBase
{
    ...
    public required ApiEnum<string, Country> Country
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullClass<ApiEnum<string, Country>>("country");
        }
    ...
    public required string WalletID
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullClass<string>("walletId");
        }
        init { this._rawBodyData.Set("walletId", value); }
    }

    /// <summary>
    /// Who bears the transaction fee
    /// </summary>
    public ApiEnum<string, Bearer>? Bearer
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<ApiEnum<string, Bearer>>("bearer");
        }
        init
        {
            if (value == null)
            ...
            this._rawBodyData.Set("bearer", value);
        }
    }
    ...
    public string? CustomerName
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<string>("customerName");
        }
        init
        {
            if (value == null)
            ...
            this._rawBodyData.Set("customerName", value);
        }
    }
    ...
    public CollectionInitiateMobileMoneyCollectionParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CollectionInitiateMobileMoneyCollectionParams(
        CollectionInitiateMobileMoneyCollectionParams collectionInitiateMobileMoneyCollectionParams
    )
        : base(collectionInitiateMobileMoneyCollectionParams)
    {
        this._rawBodyData = new(collectionInitiateMobileMoneyCollectionParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static CollectionInitiateMobileMoneyCollectionParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(CollectionInitiateMobileMoneyCollectionParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/api/v1/bila/collections/mobile-money"
        )
        {
...
/// Who bears the transaction fee
/// </summary>
[JsonConverter(typeof(BearerConverter))]
public enum Bearer
{
    Merchant,
    Customer,
...
sealed class BearerConverter : JsonConverter<Bearer>
{
    public override Bearer Read(
        ref Utf8JsonReader reader,
        Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "merchant" => Bearer.Merchant,
            "customer" => Bearer.Customer,
            _ => (Bearer)(-1),
        };
    }

    public override void Write(Utf8JsonWriter writer, Bearer value, JsonSerializerOptions options)
    {
        JsonSerializer.Serialize(
            writer,
            value switch
