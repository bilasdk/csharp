...
public record class TransferRecipientListParams : ParamsBase
{
    ...
    /// </summary>
    public ApiEnum<string, global::Usebila.Models.TransferRecipients.Type>? Type
    {
        get
        {
            this._rawQueryData.Freeze();
            return this._rawQueryData.GetNullableClass<
                ApiEnum<string, global::Usebila.Models.TransferRecipients.Type>
            >("type");
        }
        init
        {
...
sealed class TypeConverter : JsonConverter<global::Usebila.Models.TransferRecipients.Type>
{
    public override global::Usebila.Models.TransferRecipients.Type Read(
    ...
    )
    {
        ...
        {
            "bank-account" => global::Usebila.Models.TransferRecipients.Type.BankAccount,
            "mobile-money" => global::Usebila.Models.TransferRecipients.Type.MobileMoney,
            _ => (global::Usebila.Models.TransferRecipients.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::Usebila.Models.TransferRecipients.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::Usebila.Models.TransferRecipients.Type.BankAccount => "bank-account",
                global::Usebila.Models.TransferRecipients.Type.MobileMoney => "mobile-money",
