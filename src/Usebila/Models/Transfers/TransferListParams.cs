...
public record class TransferListParams : ParamsBase
{
    ...
    /// </summary>
    public ApiEnum<string, global::Usebila.Models.Transfers.Type>? Type
    {
        get
        {
            this._rawQueryData.Freeze();
            return this._rawQueryData.GetNullableClass<
                ApiEnum<string, global::Usebila.Models.Transfers.Type>
            >("type");
        }
        init
        {
...
sealed class TypeConverter : JsonConverter<global::Usebila.Models.Transfers.Type>
{
    public override global::Usebila.Models.Transfers.Type Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "bank-account" => global::Usebila.Models.Transfers.Type.BankAccount,
            "mobile-money" => global::Usebila.Models.Transfers.Type.MobileMoney,
            _ => (global::Usebila.Models.Transfers.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::Usebila.Models.Transfers.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::Usebila.Models.Transfers.Type.BankAccount => "bank-account",
                global::Usebila.Models.Transfers.Type.MobileMoney => "mobile-money",
                _ => throw new BilaInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
