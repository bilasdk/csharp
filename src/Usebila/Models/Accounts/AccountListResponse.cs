...
public sealed record class Data : JsonModel
{
    ...
    /// List of accounts
    /// </summary>
    public required IReadOnlyList<AccountResponseDto> DataValue
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullStruct<ImmutableArray<AccountResponseDto>>("data");
        }
        init
        {
            this._rawData.Set<ImmutableArray<AccountResponseDto>>(
                "data",
