...
using Usebila.Services;

namespace Usebila;

/// <inheritdoc/>
public sealed class BilaClient : IBilaClient
{
    ...
    readonly Lazy<IBilaClientWithRawResponse> _withRawResponse;

    /// <inheritdoc/>
    public IBilaClientWithRawResponse WithRawResponse
    {
        get { return _withRawResponse.Value; }
    }

    /// <inheritdoc/>
    public IBilaClient WithOptions(Func<ClientOptions, ClientOptions> modifier)
    {
        return new BilaClient(modifier(this._options));
    }
    ...
    readonly Lazy<ITransferRecipientService> _transferRecipients;
    public ITransferRecipientService TransferRecipients
    {
        get { return _transferRecipients.Value; }
    }
    ...
    readonly Lazy<IBankService> _banks;
    public IBankService Banks
    {
        get { return _banks.Value; }
    }

    readonly Lazy<IResolveService> _resolve;
    public IResolveService Resolve
    {
        get { return _resolve.Value; }
    }
    ...
    public BilaClient()
    {
        ...
        _withRawResponse = new(() => new BilaClientWithRawResponse(this._options));
        _accounts = new(() => new AccountService(this));
        _transferRecipients = new(() => new TransferRecipientService(this));
        _transfers = new(() => new TransferService(this));
        ...
        _banks = new(() => new BankService(this));
        _resolve = new(() => new ResolveService(this));
    }

    public BilaClient(ClientOptions options)
        : this()
    {
        _options = options;
    }
...
/// <inheritdoc/>
public sealed class BilaClientWithRawResponse : IBilaClientWithRawResponse
{
#if NET
    ...
    /// <inheritdoc/>
    public IBilaClientWithRawResponse WithOptions(Func<ClientOptions, ClientOptions> modifier)
    {
        return new BilaClientWithRawResponse(modifier(this._options));
    }
    ...
    readonly Lazy<ITransferRecipientServiceWithRawResponse> _transferRecipients;
    public ITransferRecipientServiceWithRawResponse TransferRecipients
    {
        get { return _transferRecipients.Value; }
    }
    ...
    readonly Lazy<IBankServiceWithRawResponse> _banks;
    public IBankServiceWithRawResponse Banks
    {
        get { return _banks.Value; }
    }

    readonly Lazy<IResolveServiceWithRawResponse> _resolve;
    public IResolveServiceWithRawResponse Resolve
    {
        get { return _resolve.Value; }
    }
        ...
        where T : ParamsBase
    {
        ...
        while (true)
        {
            ...
            if (response != null && (++retries > maxRetries || !ShouldRetry(response)))
            {
                ...
                try
                {
                    throw BilaExceptionFactory.CreateApiException(
                        response.StatusCode,
                ...
                {
                    throw new BilaIOException("I/O Exception", e);
                }
                finally
                {
                    response.Dispose();
    ...
    {
        return e is IOException || e is BilaIOException;
    }

    public void Dispose() => this.HttpClient.Dispose();

    public BilaClientWithRawResponse()
    {
        _options = new();

        _accounts = new(() => new AccountServiceWithRawResponse(this));
        _transferRecipients = new(() => new TransferRecipientServiceWithRawResponse(this));
        _transfers = new(() => new TransferServiceWithRawResponse(this));
        ...
        _banks = new(() => new BankServiceWithRawResponse(this));
        _resolve = new(() => new ResolveServiceWithRawResponse(this));
    }

    public BilaClientWithRawResponse(ClientOptions options)
        : this()
    {
        _options = options;
    }
