...
public sealed record class Data : JsonModel
{
    ...
    /// List of collections
    /// </summary>
    public required IReadOnlyList<BilaCollectionResponseDto> DataValue
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullStruct<ImmutableArray<BilaCollectionResponseDto>>(
                "data"
            );
        }
        init
        {
            this._rawData.Set<ImmutableArray<BilaCollectionResponseDto>>(
                "data",
