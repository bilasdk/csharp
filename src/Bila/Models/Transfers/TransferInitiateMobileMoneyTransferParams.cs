...
/// </summary>
public record class TransferInitiateMobileMoneyTransferParams : ParamsBase
{
    ...
    /// Country code
    /// </summary>
    public required ApiEnum<string, TransferInitiateMobileMoneyTransferParamsCountry> Country
    {
        get
        {
            this._rawBodyData.Freeze();
    ...
    public TransferInitiateMobileMoneyTransferParams() { }
...
#pragma warning disable CS8618
    ...
    public TransferInitiateMobileMoneyTransferParams(
        ...
        : base(transferInitiateMobileMoneyTransferParams)
    {
        this._rawBodyData = new(transferInitiateMobileMoneyTransferParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static TransferInitiateMobileMoneyTransferParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(TransferInitiateMobileMoneyTransferParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override System::Uri Url(ClientOptions options)
    {
        return new System::UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/api/v1/bila/transfers/mobile-money"
        )
        {
...
/// Country code
/// </summary>
[JsonConverter(typeof(TransferInitiateMobileMoneyTransferParamsCountryConverter))]
public enum TransferInitiateMobileMoneyTransferParamsCountry
{
    Zm,
    Ng,
}

sealed class TransferInitiateMobileMoneyTransferParamsCountryConverter
    : JsonConverter<TransferInitiateMobileMoneyTransferParamsCountry>
{
    public override TransferInitiateMobileMoneyTransferParamsCountry Read(
    ...
    )
    {
        ...
        {
            "zm" => TransferInitiateMobileMoneyTransferParamsCountry.Zm,
            "ng" => TransferInitiateMobileMoneyTransferParamsCountry.Ng,
            _ => (TransferInitiateMobileMoneyTransferParamsCountry)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        TransferInitiateMobileMoneyTransferParamsCountry value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                TransferInitiateMobileMoneyTransferParamsCountry.Zm => "zm",
                TransferInitiateMobileMoneyTransferParamsCountry.Ng => "ng",
