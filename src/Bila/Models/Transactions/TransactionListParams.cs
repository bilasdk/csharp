...
public record class TransactionListParams : ParamsBase
{
    ...
    /// </summary>
    public ApiEnum<string, global::Bila.Models.Transactions.Type>? Type
    {
        get
        {
            this._rawQueryData.Freeze();
            return this._rawQueryData.GetNullableClass<
                ApiEnum<string, global::Bila.Models.Transactions.Type>
            >("type");
        }
        init
        {
...
sealed class TypeConverter : JsonConverter<global::Bila.Models.Transactions.Type>
{
    public override global::Bila.Models.Transactions.Type Read(
    ...
    )
    {
        ...
        {
            "credit" => global::Bila.Models.Transactions.Type.Credit,
            "debit" => global::Bila.Models.Transactions.Type.Debit,
            _ => (global::Bila.Models.Transactions.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::Bila.Models.Transactions.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::Bila.Models.Transactions.Type.Credit => "credit",
                global::Bila.Models.Transactions.Type.Debit => "debit",
