...
public class TransferRecipientCreateMobileMoneyResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new TransferRecipientCreateMobileMoneyResponse
        {
        ...
        TransferRecipientCreateMobileMoneyResponseIntersectionMember1Data expectedData = new()
        {
            ID = "68f11209-451f-4a15-bfcd-d916eb8b09f4",
            AccountName = "John Doe",
            Country = "zm",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<TransferRecipientCreateMobileMoneyResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        TransferRecipientCreateMobileMoneyResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class TransferRecipientCreateMobileMoneyResponseIntersectionMember1Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new TransferRecipientCreateMobileMoneyResponseIntersectionMember1
        {
            Data = new()
            {
                ID = "68f11209-451f-4a15-bfcd-d916eb8b09f4",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<TransferRecipientCreateMobileMoneyResponseIntersectionMember1>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        TransferRecipientCreateMobileMoneyResponseIntersectionMember1 copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class TransferRecipientCreateMobileMoneyResponseIntersectionMember1DataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new TransferRecipientCreateMobileMoneyResponseIntersectionMember1Data
        {
            ID = "68f11209-451f-4a15-bfcd-d916eb8b09f4",
            AccountName = "John Doe",
            Country = "zm",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<TransferRecipientCreateMobileMoneyResponseIntersectionMember1Data>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        TransferRecipientCreateMobileMoneyResponseIntersectionMember1Data copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class TransferRecipientCreateMobileMoneyResponseIntersectionMember1DataTypeTest : TestBase
{
    [Theory]
    [InlineData(TransferRecipientCreateMobileMoneyResponseIntersectionMember1DataType.BankAccount)]
    [InlineData(TransferRecipientCreateMobileMoneyResponseIntersectionMember1DataType.MobileMoney)]
    public void Validation_Works(
        TransferRecipientCreateMobileMoneyResponseIntersectionMember1DataType rawValue
    )
    {
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<
            ApiEnum<string, TransferRecipientCreateMobileMoneyResponseIntersectionMember1DataType>
