...
public class ResolveMobileMoneyResponseTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        ResolveMobileMoneyResponseIntersectionMember1Data expectedData = new()
        {
            AccountName = "John Doe",
            Country = "zm",
            AccountNumber = "1234567890",
...
public class ResolveMobileMoneyResponseIntersectionMember1Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ResolveMobileMoneyResponseIntersectionMember1
        {
            Data = new()
            {
                AccountName = "John Doe",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<ResolveMobileMoneyResponseIntersectionMember1>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ResolveMobileMoneyResponseIntersectionMember1 copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ResolveMobileMoneyResponseIntersectionMember1DataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ResolveMobileMoneyResponseIntersectionMember1Data
        {
            AccountName = "John Doe",
            Country = "zm",
            AccountNumber = "1234567890",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<ResolveMobileMoneyResponseIntersectionMember1Data>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ResolveMobileMoneyResponseIntersectionMember1Data copied = new(model);
